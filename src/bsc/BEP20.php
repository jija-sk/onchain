...
//        $data = "0x{$formatMethod}{$formatAddress}{$formatInteger}";
//        $transaction = new Transaction($nonce,$gasPrice,'0xea60',$this->contractAddress,Utils::NONE,$data);
//        $raw = $transaction->getRaw($privateKey,self::getChainId($this->proxyApi->getNetwork()));
